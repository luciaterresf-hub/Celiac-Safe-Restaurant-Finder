...
def load_data():
    candidate_paths = (
        candidate_file_paths("data", "restaurant_ranking.csv")
        + candidate_file_paths("restaurant_ranking.csv")
        + candidate_file_paths("data", "final.csv")
        + candidate_file_paths("final.csv")
    )
...
def load_reviews():
    candidate_paths = (
        candidate_file_paths("data", "clean_data.csv")
        + candidate_file_paths("clean_data.csv")
    )
...
def load_images():
    candidate_paths = (
        candidate_file_paths("data", "imagenes.csv")
        + candidate_file_paths("imagenes.csv")
    )
